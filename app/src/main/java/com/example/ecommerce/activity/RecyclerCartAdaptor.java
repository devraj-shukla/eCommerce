...
public class RecyclerCartAdaptor extends RecyclerView.Adapter<RecyclerCartAdaptor.ViewHolder> {
    ...
    public RecyclerCartAdaptor(List<Product> recommendProductList, ProductDetailsInterface mProductDataInterface ) {
