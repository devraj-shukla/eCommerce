...
public class RecyclerProductListing extends RecyclerView.Adapter<RecyclerProductListing.ViewHolder> {

    private List<Product> mProductDataList;
    private ProductListDetailsInterface mProductDataListInterface ;




    public RecyclerProductListing(List<Product> productList, RecyclerProductListing.ProductListDetailsInterface mProductDataListInterface ) {
        this.mProductDataList = productList;
        this.mProductDataListInterface = mProductDataListInterface;
    }


    @NonNull
    @Override
    public RecyclerProductListing.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_recycler_product_listing, parent, false);
        return new RecyclerProductListing.ViewHolder(view);
    }


    public void onBindViewHolder(@NonNull RecyclerProductListing.ViewHolder holder, int position) {
...
//        holder.add_to_cart.setOnClickListener((view -> mProductDataInterface.add_to_cart(productData.getpId())));
        holder.rootview_product.setOnClickListener((view -> mProductDataListInterface.onUserClick(productData)));
    }
...
//            add_to_cart=view.findViewById(R.id.buttoncart);
    ...
    public interface ProductListDetailsInterface{
